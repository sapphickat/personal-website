...
const links = [
    // { href: "https:// xxxxxxxxxxxxxx.tumblr.com", icon: FaSquareTumblr, color: "#36465D", customClass: "rainbow-icon " },
...
export default function SocialLinks({defaultColor}) {
    return (
...
function SocialLink({href, icon: Icon, color, customClass}) {
